...
const favoritesRepository = __importStar(require("../repositories/favoritesRepository"));
...
function createFavorite(productId, userId) {
    return __awaiter(this, void 0, void 0, function* () {
        const existingProduct = yield productsRepository.getProduct(productId);
        if (!existingProduct) {
            throw new NotFoundError_1.default('product', productId);
        }
        const existingFavorite = yield favoritesRepository.getFavorite(productId, userId);
        if (existingFavorite) {
            throw new BadRequestError_1.default('Already favorited');
        }
        yield favoritesRepository.createFavorite({ productId, userId });
    });
}
function deleteFavorite(productId, userId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield favoritesRepository.deleteFavorite(existingFavorite.id);
    });
}
