...
function updateUser(userId, data) {
    return __awaiter(this, void 0, void 0, function* () {
        const updatedUser = yield usersRepository.updateUser(userId, data);
        return updatedUser;
    });
}
function getMyProductList(userId, params) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield productsRepository.getProductListWithFavorites(params, { userId });
        return result;
    });
}
function getMyFavoriteList(userId, params) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield productsRepository.getFavoriteProductListByOwnerId(userId, params);
        return result;
    });
}
